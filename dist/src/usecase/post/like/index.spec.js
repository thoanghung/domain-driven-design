...
describe('LikePost Usecase Testing', () => {
    ...
    describe('Abnormal case', () => {
        ...
        describe('Have liked post', () => {
            ...
            it('Error info detailCode is HAVE_BEEN_LIKED_POST', () => {
                expect(error.info.detailCode).toEqual(exception_1.UsecaseErrorDetailCode.HAVE_BEEN_LIKED_POST);
            });
        });
    });
    describe('Normal case', () => {
        beforeAll(async () => {
            ...
            jest.spyOn(like_2.LikeRepository.prototype, 'save').mockResolvedValue(null);
